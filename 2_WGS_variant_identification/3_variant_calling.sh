...
#run gatk HaplotypeCaller on the array in a loop - using the 'wait' command allows each iteration to run in the background once it starts processing allowing the function to execute in parallel for all 20 chromosomes
for i in "${arr[@]}";
do
