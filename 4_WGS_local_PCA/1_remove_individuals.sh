...
#using VCFtools, create a new VCF file with the desired individuals removed (in this case samples W2 and T1). note: 4_100_max_mean_depth_80.vcf has been renamed to 4_stringent_filter_Q20RD10M100MMD80.vcf
