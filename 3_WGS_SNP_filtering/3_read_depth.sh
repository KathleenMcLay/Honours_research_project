...
#using vcf tools, filter the zipped VCF file to remove genotype data for individual samples with less than 10 reads | save the output as a zipped VCF file
