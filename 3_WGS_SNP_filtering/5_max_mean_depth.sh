...
/home/564/km6006/bin/vcftools --gzvcf ${DIR}/3_sites_missing_data_30.vcf.gz --recode --recode-INFO-all --max-meanDP 60 --stdout | gzip -c > ${DIR}/4_30_max_mean_depth_60.vcf.gz